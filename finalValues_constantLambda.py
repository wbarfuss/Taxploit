...
if __name__ == '__main__':
    ...
    savePath = '/p/tmp/barfuss/Taxploit/constantLambda'
    ...
    constantVariable = ['lambda']  # one possiblity of three!
    constantValue = [0., 0.5, 1.]  # np.linspace(0.02, 2., 100)

    # also has to be computed
    # constantVariable = ['deltaT']
    # constantValue = [0.0, 0., 1.]  # np.linspace(0.0, 1., 101)

    # also has to be computed
    # constantVariable = ['phi']
    # constantValue = [0., 0.4, 0.8]  # np.linspace(0.0, 1., 101)

    QoI = ['fracSus', 'consensTime']  # Quantity of Interest # This might not be a good idea as they are computed in the same run.
